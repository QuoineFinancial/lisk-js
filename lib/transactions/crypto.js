...
/**
 * @method getKeysFromHashedSecret
 * @param SHA256 secret string buffer
 *
 * @return {object}
 */

function getKeysFromHashedSecret (hashed_secret) {
	var keypair = naclInstance.crypto_sign_keypair_from_seed(hashed_secret);
...
module.exports = {
	...
	getKeysFromHashedSecret: getKeysFromHashedSecret,
